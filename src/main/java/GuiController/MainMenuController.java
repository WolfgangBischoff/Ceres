...
public class MainMenuController implements GUIController
{
    ...
    public MainMenuController()
    {
        ...
        loader = new FXMLLoader(getClass().getResource("../../../resources/main/fxml/mainMenu.fxml"));
    ...
    {
        leftBar.setImage(new Image("../../resources/main/img/säulePlakat.png"));
        rightBar.setImage(new Image("../../resources/main/img/säuleCommEco.png"));
    }
