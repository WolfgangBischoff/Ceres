...
import static Core.Config.BOARD_TIME_HEIGHT;
import static Core.Config.BOARD_TIME_POSITION;
import static Core.Config.BOARD_TIME_WIDTH;
...
import static Core.Config.DEBUG_MOUSE_ANALYSIS;
import static Core.Config.DISCUSSION_POSITION;
import static Core.Config.HUNGER_BAR_POSITION;
import static Core.Config.KEYBOARD_INTERACT;
import static Core.Config.KEYBOARD_INVENTORY;
import static Core.Config.MAM_BAR_HEIGHT;
import static Core.Config.MAM_BAR_POSITION;
import static Core.Config.MAM_BAR_WIDTH;
import static Core.Config.MAX_HUNGER;
import static Core.Config.MONEY_POSITION;
import static Core.Config.PERSONALITY_POSITION;
import static Core.Config.RUMBLE_GRADE;
import static Core.Config.RUMBLE_GRADE_DECREASE;
